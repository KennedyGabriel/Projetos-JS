...
console.log('Escola '.concat(escola).concat("!")); //String concatenando com a constante
console.log(escola.replace(3 , 'e')); //Troca o 'caractere antigo' pelo 'caractere novo'